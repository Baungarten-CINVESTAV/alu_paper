...
set ::env(CLOCK_NET) "Top_Module_4_ALU.clk"
set ::env(CLOCK_PERIOD) "10"

## Internal Macros
### Macro PDN Connections
set ::env(FP_PDN_MACRO_HOOKS) "\
	Top_Module_4_ALU vdd vss vdd vss"
...
set ::env(VERILOG_FILES_BLACKBOX) "\
	$::env(CARAVEL_ROOT)/verilog/rtl/defines.v \
	$::env(DESIGN_DIR)/../../verilog/rtl/Top_Module_4_ALU.v"

set ::env(EXTRA_LEFS) "\
	$::env(DESIGN_DIR)/../../lef/Top_Module_4_ALU.lef"

set ::env(EXTRA_GDS_FILES) "\
	$::env(DESIGN_DIR)/../../gds/Top_Module_4_ALU.gds"
